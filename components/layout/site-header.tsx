...
export function SiteHeader({ avatar, name }: SiteHeaderProps) {
  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 h-16 bg-background transition-all duration-300 ${
    ...
    >
      <div className="mx-auto flex h-full w-full max-w-7xl items-center justify-between px-4">
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="hidden font-semibold sm:block">
              {t('metadata.siteTitle', { name: name || 'Guany' })}
            </span>
          </Link>
        </div>
        ...
        <nav className="flex items-center gap-2 sm:gap-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="hidden items-center gap-1.5 text-muted-foreground transition-colors hover:text-foreground sm:flex">
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              nativeButton={false}
              render={<Link href="/projects" aria-label={t('nav.projects')} />}
            >
            ...
            <Button
              ...
              className="size-8 sm:hidden"
              nativeButton={false}
              render={<Link href="/docs" aria-label={t('nav.docs')} />}
            >
            ...
            <Button
              ...
              className="size-8 sm:hidden"
              nativeButton={false}
              render={<Link href="/uses" aria-label={t('nav.uses')} />}
            >
